...
@ccclass
export default class EnemyObjPoolMgr {

    private static _ins: EnemyObjPoolMgr = null;
    public static get ins(): EnemyObjPoolMgr {
        if (!this._ins) {
            this._ins = new EnemyObjPoolMgr();
        }
        return this._ins;
    }
